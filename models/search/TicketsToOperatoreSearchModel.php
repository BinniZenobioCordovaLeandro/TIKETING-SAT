 ...
 */
class TicketsToOperatoreSearchModel extends TicketsModel
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'operatore_gpi', explode(" ",OperatoriModel::getNomeOperatoreById(Yii::$app->user->id))[0]]);
        $query->andFilterWhere(['like', 'operatore_gpi', explode(" ",OperatoriModel::getNomeOperatoreById(Yii::$app->user->id))[1]]);
        if($this->solleciti){
